...
export class Filter implements FilterInfo {
    ...
    constructor(readonly system: System, readonly using: SchemaName, readonly source: FilterJson = {}) {
        // source.where
    ...
    async selectAll() {
        return this.system.data.selectAll(this.using, this);
    }

    async selectOne() {
        return this.system.data.selectOne(this.using, this);
    }

    async select404() {
        return this.system.data.select404(this.using, this);
    }
}
